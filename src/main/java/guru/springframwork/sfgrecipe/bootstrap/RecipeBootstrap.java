...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        guacRecipe.getIngredients().add(new Ingredient("serrano chiled, stems and seeds removed, monced", new BigDecimal(2),eachUom, guacRecipe));
        ...
        guacRecipe.getIngredients().add(new Ingredient("ripe tomato, seeds and pulp removed, chooped", new BigDecimal(.5),eachUom, guacRecipe));
